...
menu.addDishToCourse('mains', 'enchilada', 7.50);
menu.addDishToCourse('mains', 'burrito', 8.00);
menu.addDishToCourse('mains', 'chili relleno', 10.00);

menu.addDishToCourse('desserts', 'fudge brownie', 4.50);
menu.addDishToCourse('desserts', 'chocolate cake', 5.00);
menu.addDishToCourse('desserts', 'churros', 4.00);
